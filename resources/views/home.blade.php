                ...
                <div class="flex flex-wrap -m-4">
                    <div class="xl:w-1/3 md:w-1/2 p-4">
                        <div class="border border-gray-300 p-6 rounded-lg">
                            ...
                            <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Key Features</h2>
                    ...
                    <div class="xl:w-1/3 md:w-1/2 p-4">
                        <div class="border border-gray-300 p-6 rounded-lg">
                            ...
                            <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Bording
                            Finder</h2>
                            <p class="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co,
                                subway
                                tile
                    ...
                    <div class="xl:w-1/3 md:w-1/2 p-4">
                        <div class="border border-gray-300 p-6 rounded-lg">
                            <div
                                class="w-10 h-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4">
                                <i class="fa-solid fa-solid fa-shield-halved "></i>
                            </div>
                            <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Academic
                            Support</h2>
                            <p class="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co,
                                subway
                                tile
                    ...
                    <div class="xl:w-1/3 md:w-1/2 p-4">
                        <div class="border border-gray-300 p-6 rounded-lg">
                            ...
                            <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Security
                            Service</h2>
                            <p class="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co,
                                subway
                                tile
                    ...
                    <div class="xl:w-1/3 md:w-1/2 p-4">
                        <div class="border border-gray-300 p-6 rounded-lg">
                            ...
                            <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Boarding
                            Adverticesment</h2>
                            <p class="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co,
                                subway
                                tile
                    ...
                    <div class="xl:w-1/3 md:w-1/2 p-4">
                        <div class="border border-gray-300 p-6 rounded-lg">
                            ...
                            <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Recreational
                            &
                            Fitness Services</h2>
                            <p class="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co,
                                subway
