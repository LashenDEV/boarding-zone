                        ...
                        <div id="default-carousel" data-carousel="static">
                            ...
                            <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-90">
                                ...
                                <div class=" ease-in-out" data-carousel-item>
                                    ...
                                    <img src="{{asset('asserts/images/home/home-cover.jpg')}}" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                                </div>
                                <!-- Item 2 -->
                            ...
                            <button type="button" class="flex absolute top-0 left-0 z-30 justify-center items-center px-4 h-full cursor-pointer group focus:outline-none" data-carousel-prev>
                                <span class="inline-flex justify-center items-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-white/30 dark:bg-white/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
        ...
        <div class="container mx-auto flex min-h-screen flex-col px-6 py-12">
            <div class="flex-1 lg:-mx-6 lg:flex lg:items-center">
                <div class="text-white lg:mx-6 lg:w-1/2">
                    ...
                    <p class="mt-6 max-w-xl">Ask us anything. we would love to hear from you</p>
                    ...
                    <div class="mt-6 space-y-8 md:mt-8">
                        ...
                        <p class="-mx-2 flex items-start">
                            ...
                            <span class="mx-2 w-72 truncate text-white">055 5 637 401</span>
                        </p>
                ...
                <div class="mt-8 lg:mx-6 lg:w-1/2">
                    <div
                        class="mx-auto w-full overflow-hidden rounded-xl bg-white px-8 py-10 shadow-2xl dark:bg-gray-300 lg:max-w-xl">
                        <h1 class="text-2xl font-medium text-gray-700 :text-gray-200">Contact form</h1>

                        <form class="mt-6">
                            <div class="flex-1">
                                <label class="mb-2 block text-sm text-gray-600 :text-gray-200"> Name </label>
                                <input type="text" placeholder="Enter Your Name"
                                       class="mt-2 block w-full rounded-md border border-gray-200 bg-white dark:bg-gray-200 px-5 py-3 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 :border-gray-600 :bg-gray-900 :text-gray-300 :focus:border-blue-300"/>
                            </div>
                            ...
                            <div class="mt-6 w-full">
                                ...
                                <textarea
                                    class="mt-2 block h-32 w-full rounded-md border border-gray-200 bg-white dark:bg-gray-200 px-5 py-3 text-gray-700 placeholder-gray-400 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 :border-gray-600 :bg-gray-900 :text-gray-300 :focus:border-blue-300 md:h-48"
