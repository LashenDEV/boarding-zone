                    ...
                    <ul class="p-2 overflow-hidden">
                        <li>
                            <a href="{{route('super-admin.dashboard')}}"
                               class="flex items-center p-2 space-x-2 rounded-md hover:bg-blue-100 @if(Route::is('super-admin.dashboard')) bg-blue-200 @endif"
                        ...
                        <li>
                            <a href="{{route('super-admin.admins')}}"
                               class="flex items-center p-2 space-x-2 rounded-md hover:bg-blue-100 @if(Route::is('super-admin.admins')) bg-blue-200 @endif"
                               :class="{'justify-center': !isSidebarOpen}">
                                <span>
                                <i class="fa-duotone fa-users-between-lines"></i>
                                </span>
                                <span :class="{ 'lg:hidden': !isSidebarOpen }">Admins</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('super-admin.bowners')}}"
                               class="flex items-center p-2 space-x-2 rounded-md hover:bg-blue-100 @if(Route::is('super-admin.bowners')) bg-blue-200 @endif"
                               :class="{'justify-center': !isSidebarOpen}">
                                <span>
                        ...
                        <li>
                            <a href="{{route('super-admin.borders')}}"
                               class="flex items-center p-2 space-x-2 rounded-md hover:bg-blue-100 @if(Route::is('super-admin.borders')) bg-blue-200 @endif"
                               :class="{'justify-center': !isSidebarOpen}">
                                <span>
                        ...
                        {{--                        <li>--}}
                        {{--                            <a href="{{route('super-admin.dashboard')}}"--}}
                        {{--                               class="flex items-center p-2 space-x-2 rounded-md hover:bg-blue-100"--}}
                        {{--                               :class="{'justify-center': !isSidebarOpen}">--}}
                        {{--                                <span>--}}
                        {{--                                <i class="fa-duotone fa-grid-horizontal"></i>--}}
                        {{--                                </span>--}}
                        ...
                        <li>
                            <a href="{{route('super-admin.boarding-house.index')}}"
                               class="flex items-center p-2 space-x-2 rounded-md hover:bg-blue-100 @if(Route::is('super-admin.boarding-house.index')) bg-blue-200 @endif"
                               :class="{'justify-center': !isSidebarOpen}">
                                <span>
            ...
            <div class="flex flex-col flex-1 h-full overflow-hidden">
                ...
                <header class="flex-shrink-0 border-b">
                    <div class="flex items-center justify-between p-2">
                        ...
                        {{--                                type="text"--}}
                        {{--                                placeholder="Search"--}}
                        {{--                                class="px-4 py-3 rounded-md hover:bg-blue-100 lg:max-w-sm md:py-2 md:flex-1 focus:outline-none md:focus:bg-gray-100 md:focus:shadow md:focus:border"--}}
                        {{--                            />--}}
                        {{--                        </div>--}}
                        ...
                        <div class="relative flex items-center space-x-3">
                            ...
                            <div class="items-center hidden space-x-3 md:flex">
                                ...
                                <div class="relative" x-data="{ isOpen: false }">
                                    @php($notifications = \App\Models\Notification::where('seenBySAdmin', 'Unseen')->get())
                                                ...
                                                @foreach($notifications as $notification)
                                                    ...
                                                    <span
                                                        class="block ps-2 transition rounded-md">{{$notification->message}} <a
                                                            href="{{route('notification.readBySAdmin', $notification->id)}}"
                                ...
                                <div x-data="{ isOpen: false }">
                                    ...
                                    >
                                        ...
                                        <ul class="flex flex-col p-2 my-3 space-y-3">
                                            <li>
                                                <a href="#"
                                                   class="flex items-start px-2 py-1 space-x-2 rounded-md hover:bg-blue-100">
                                ...
                                <div class="relative" x-data="{ isOpen: false }">
                                    ...
                                    >
                                        ...
                                        <ul class="flex flex-col p-2 my-2 space-y-1">
                                            <li>
                                                <a href="#"
                                                   class="block px-2 py-1 transition rounded-md hover:bg-blue-100">Link</a>
                                            </li>
                                            <li>
                                                <a href="#"
                                                   class="block px-2 py-1 transition rounded-md hover:bg-blue-100">Another
                                                    Link</a>
                                            </li>
                                        </ul>
                                        <div
                            ...
                            <div class="relative" x-data="{ isOpen: false }">
                                ...
                                >
                                    ...
                                    {{--                                        <li>--}}
                                    {{--                                            <a href="#"--}}
                                    {{--                                               class="block px-2 py-1 transition rounded-md hover:bg-blue-100">Profile</a>--}}
                                    {{--                                        </li>--}}
                                    {{--                                        <li>--}}
                                    {{--                                            <a href="#" class="block px-2 py-1 transition rounded-md hover:bg-blue-100">My--}}
                                    {{--                                                Boarding Places</a>--}}
                                    {{--                                        </li>--}}
                                    {{--                                    </ul>--}}
