            ...
            O<span :class="{'lg:hidden': !isSidebarOpen}">wner </span>D<span
                ...
                <nav class="flex-1 overflow-hidden hover:overflow-y-auto">
                    <ul class="p-2 overflow-hidden">
                        ...
                        <li>
                            <a href="{{route('bowner.borders')}}"
                               class="flex items-center p-2 space-x-2 rounded-md hover:bg-blue-100 @if(Route::is('bowner.borders')) bg-blue-200 @endif"
                               :class="{'justify-center': !isSidebarOpen}">
                                <span>
                        ...
                        <div class="relative flex items-center space-x-3">
                            ...
                            <div class="items-center hidden space-x-3 md:flex">
                                ...
                                <div class="relative" x-data="{ isOpen: false }">
                                    @php($notifications = \App\Models\Notification::where('bowner_id', \Illuminate\Support\Facades\Auth::user()->id)->where('seenByBowner', 'Unseen')->get())
                                                ...
                                                @foreach($notifications as $notification)
                                                    ...
                                                    <span
                                                        class="block ps-2 transition rounded-md">{{$notification->message}} <a
                                                            href="{{route('notification.readByBOwner', $notification->id)}}"
