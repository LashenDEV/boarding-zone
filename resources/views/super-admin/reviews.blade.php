                            ...
                            <span
                                ...
                                @endif
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        <a href="{{route('super-admin.boarding-house.review.approve', $review->id)}}"
                                           class="text-green-600 hover:text-green-900">Approve</a> |
                                        <a href="{{route('super-admin.boarding-house.review.reject', $review->id)}}"
                                           class="text-red-600 hover:text-red-900">Reject</a> |
                                        <a href="{{route('super-admin.boarding-house.review.remove', $review->id)}}"
