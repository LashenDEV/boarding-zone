...
@section('main')
    ...
    <h3 class="mt-6 text-xl">Your Boading Reviews</h3>
                            ...
                            <span
                                ...
                                @endif
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        <a href="{{route('boarding-owner.boarding-house.review.approve', $review->id)}}"
                                           class="text-green-600 hover:text-green-900">Approve</a> |
                                        <a href="{{route('boarding-owner.boarding-house.review.reject', $review->id)}}"
                                           class="text-red-600 hover:text-red-900">Reject</a> |
                                        <a href="{{route('boarding-owner.boarding-house.review.remove', $review->id)}}"
