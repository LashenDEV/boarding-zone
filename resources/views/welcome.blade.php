        ...
        <main>
            <section class="bg-white dark:bg-gray-900">
                <nav x-data="{ isOpen: false }" class="container mx-auto p-6 lg:flex lg:items-center lg:justify-between">
                    <div class="flex items-center justify-between">
                        <div>
                            <a class="text-2xl font-bold text-gray-800 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 lg:text-5xl" href="#">BORDING ZONE</a>
                        </div>
                    ...
                    <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 w-full bg-white px-6 py-4 shadow-md transition-all duration-300 ease-in-out dark:bg-gray-900 lg:relative lg:top-0 lg:mt-0 lg:flex lg:w-auto lg:translate-x-0 lg:items-center lg:bg-transparent lg:p-0 lg:opacity-100 lg:shadow-none lg:dark:bg-transparent">
                        <div class="lg:-px-8 flex flex-col space-y-4 lg:mt-0 lg:flex-row lg:space-y-0">
                            ...
                            <a class="transform text-gray-700 transition-colors duration-300 hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400 lg:mx-8" href="#">Service</a>
                            ...
                            <a class="transform text-gray-700 transition-colors duration-300 hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400 lg:mx-8" href="#">Contact Us</a>
                            <a class="transform text-gray-700 transition-colors duration-300 hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400 lg:mx-8" href="#">Logins</a>
                        </div>

                        <a class="mt-4 block rounded-lg bg-blue-600 px-6 py-2.5 text-center font-medium capitalize leading-5 text-white hover:bg-blue-500 lg:mt-0 lg:w-auto" href="#"> Book a Place </a>
                    </div>
                </nav>
                ...
                <div class="container mx-auto px-6 py-16 text-center">
                    ...
                    <div class="mt-10 flex justify-center">
                        <img class="h-100 w-full rounded-xl object-cover lg:w-6/5" src="{{ URL::asset('asserts\images\home\home-cover.JPG') }}" />
                    </div>
                </div>
            </section>
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="container mx-auto px-6 py-10">
                    <h1 class="text-center text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-5xl">Our Key Features</h1>
                    ...
                    <p class="mt-4 text-center text-gray-500 dark:text-gray-300">Take a look at some of our key features</p>
                            ...
                            <div class="grid grid-cols-3 gap-36 p-24">
                                    <div class="flex flex-col justify-center items-center"><i class="fa-solid fa-magnifying-glass fa-5x" style="color: #ffffff;"></i>
                                    <h2 class="mt-7 text-xl font-semibold capitalize text-gray-800 dark:text-white">Bording Finder</h2>
                                </div>
                                <div class="flex flex-col justify-center items-center"><i class="fa-solid fa-handshake-angle fa-5x" style="color: #ffffff;"></i>
                                    <h2 class="mt-7 text-xl font-semibold capitalize text-gray-800 dark:text-white">Academic Support Service</h2>
                                </div>
                                <div class="flex flex-col justify-center items-center"><i class="fa-solid fa-solid fa-shield-halved fa-5x" style="color: #ffffff;"></i>
                                    <h2 class="mt-7 text-xl font-semibold capitalize text-gray-800 dark:text-white">Security Service</h2>
                                </div>
                                <div class="flex flex-col justify-center items-center"><i class="fa-solid fa-bullhorn fa-5x" style="color: #ffffff;"></i>
                                    <h2 class="mt-7 text-xl font-semibold capitalize text-gray-800 dark:text-white">Boarding Adverticesment</h2>
                                </div>
                                <div class="flex flex-col justify-center items-center"><i class="fa-solid fa-dumbbell fa-5x" style="color: #ffffff;"></i>
                                    <h2 class="mt-7 text-xl font-semibold capitalize text-gray-800 dark:text-white">Recreational & Fitness Services</h2>
                                </div>
                                <div class="flex flex-col justify-center items-center"><i class="fa-solid fa-plate-utensils fa-5x" style="color: #ffffff;"></i>
                                    <h2 class="mt-7 text-xl font-semibold capitalize text-gray-800 dark:text-white">Food Services</h2>
                                </div>
