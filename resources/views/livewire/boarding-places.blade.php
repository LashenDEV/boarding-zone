                        ...
                        <div
                            ...
                            <div class="p-5">
                                ...
                                <div class="flex flex-row justify-end">
                                    <a href="{{route('view-boarding-place', $boarding_place->id)}}" class="ml-1 cursor-pointer text-white bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
