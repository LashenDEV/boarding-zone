        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    <h2 class="text-sm title-font text-gray-500 tracking-widest">{{$boarding_place->name}}</h2>
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{{$boarding_place->name}}</h1>
                    <div class="flex mb-4">
            ...
            <a class="ml-2 text-gray-500">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5"
                ...
                <path
                    ...
                    <p class="leading-relaxed">{{$boarding_place->features}}</p>
                    ...
                    <div class="flex">
                        <span class="title-font font-medium text-2xl text-gray-900">Rs. {{$boarding_place->price}} /= per month</span>
                        <button
                            class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">
                            Reserve
                        </button>
                        <button wire:click="reserve({{$boarding_place->id}})"
